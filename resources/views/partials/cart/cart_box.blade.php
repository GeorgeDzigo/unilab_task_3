<div class="col-md-6">
    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col-auto d-none d-lg-block border shadow-sm">
            <img class="bd-placeholder-img" style="max-width:300px; max-height:300px;" height="100%" width="100%" src="{{ $product->photo_path }}" role="png" aria-label="Placeholder: Thumbnail" preserveaspectratio="xMidYMid slice" focusable="false">
        </div>
